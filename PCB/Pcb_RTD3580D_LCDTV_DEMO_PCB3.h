...
//_KT_PCB2660_001 
//--------------------------------------------------
#define _KEY_TYPE                               _KT_PCB2660_003 // 2
...
#define _KEY_SCAN_TYPE                          _KEY_SCAN_NORMAL
...
#define _PIN_50 								(1 & 0x07)	// 0 ~ 5 (0: P6D0i, 1: P6D0o<open-drain>, 2: P6D0o<push-pull>, 3: ADCA0, 4: AVOUT, 5: VCLK)
#define _PIN_51 								(1 & 0x03)	// 0 ~ 3 (0: P6D1i, 1: P6D1o<open-drain>, 2: P6D1o<push-pull>, 3: ADCA1)
...
#define _PIN_55 								(1 & 0x07)	// 0 ~ 5 (0: P6D5i, 1: P6D5o<open-drain>, 2: P6D5o<push-pull>, 3: ADCB0, 4: PWM1, 5: PWM5)
...
#define _PIN_65 								(7 & 0x07)	// 0 ~ 7 (0: P1D1i, 1: P1D1o<open-drain>, 2: P1D1o<push-pull>, 3: T2EX, 4: TCON[1], 5: TCON[7], 6: WS, 7: PWM1)
...
#define _PIN_71 								(0 & 0x0f)	// 0 ~ 8 (0: P1D7i, 1: P1D7o<open-drain>, 2: P1D7o<push-pull>, 3: SD3, 4: TCON[8], 5: TCON[10], 6: SPDIF3, 7: PWM1, 8: PWM5) Effective only if 8-bit TTL Disable.

#define _PIN_74to83 							(0 & 0x03)	// 0 ~ 2 (0: None, 1: GPI, 2: GPO) Effective only if single-port LVDS without E/O swap.

#define _PIN_96 								(0 & 0x07)	// 0 ~ 4 (0: P5D2i, 1: P5D2o<open-drain>, 2: P5D2o<push-pull>, 3: PWM0, 4: DCLK)
#define _PIN_97 								(0 & 0x07)	// 0 ~ 4 (0: P5D3i, 1: P5D3o<open-drain>, 2: P5D3o<push-pull>, 3: PWM1, 4: DVS)
#define _PIN_98 								(0 & 0x03)	// 0 ~ 3 (0: P5D4i, 1: P5D4o<open-drain>, 2: P5D4o<push-pull>, 3: PWM2)
#define _PIN_99 								(0 & 0x07)	// 0 ~ 5 (0: P5D5i, 1: P5D5o<open-drain>, 2: P5D5o<push-pull>, 3: PWM3, 4: TCON[6], 5: TCON[11])
...
#define bHDMICONNECT							(_MCU_PORT55)
sbit    bHot_Plug                               = P3^7;
...
#define bAD0_Key_0                              2   //Power       
#define bAD0_Key_1                              44  //Down
#define bAD0_Key_2                              22  //Up

#define bAD1_Key_0                              55  //Left
#define bAD1_Key_1								13  //Right
#define bAD1_Key_2								37  //Source

#define bAD2_Key_0							    16  //Menu
#define bAD2_Key_1							    34  //Menu
#define bAD2_Key_2                              0
...
//            Audio definitions
//--------------------------------------------------
#define AUDIO_TYPE                              _AUDIO_SC7313      // _AUDIO_SC7313,_AUDIO_PWM 
...
#define _AUDIO_A                                (_MCU_PORT63)
#define _AUDIO_B                                (_MCU_PORT62)

#define _VOLUME_INV                             1
#define _MAX_VOLUME                             255
