...
code PanelType Panel0 =
{
   ...
   ///_RSDS_HL_SWAP |
	...
	550,        // Display Horizontal Total Clock Number in One Display Line

	550,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	550,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	8,//22,         // Display Vertical Start Position
	234,        // Display Vertical Height

	380,        // Display Vertical Total Line Number in One Frame

	16,         // Display H Sync Width
	3,          // Display V Sync Height

	39,         // Typical Pixel Clock in MHz
