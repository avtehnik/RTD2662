...
code PanelType Panel1 =
{
	...
	930,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	890,//960,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC
