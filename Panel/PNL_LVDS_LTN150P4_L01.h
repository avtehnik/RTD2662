...
code PanelType Panel1 =
{
	...
	32,         // Display Horizontal Start Position
	1400,       // Display Horizontal Width

	1580,       // Display Horizontal Total Clock Number in One Display Line

	1580,       // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1580,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	32,         // Display Vertical Start Position
	1050,       // Display Vertical Height

	1180,       // Display Vertical Total Line Number in One Frame

	29,         // Display H Sync Width
	3,          // Display V Sync Height
...
code PanelType Panel3 =
{
	...
	38,         // Display Vertical Start Position
	1050,        // Display Vertical Height
