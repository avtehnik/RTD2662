...
code PanelType Panel0 =
{
	...
	1480,       // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1410,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC
