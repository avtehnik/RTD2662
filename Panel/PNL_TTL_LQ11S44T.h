...
code PanelType Panel2 =
{
	...
	1024,        // 1Display Horizontal Total Clock Number in One Display Line

	1152,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1152,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	12,         // Display Vertical Start Position
	600,        // Display Vertical Height

	780,        // Display Vertical Total Line Number in One Frame

	16,         // Display H Sync Width
	3,//0x36,//3,          // Display V Sync Height
