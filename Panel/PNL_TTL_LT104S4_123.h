...
code PanelType Panel0 =
{
	...
	32, //136,//60,         // Display Horizontal Start Position
	800,//640,        // Display Horizontal Width

	952,        // Display Horizontal Total Clock Number in One Display Line

	910,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	830, //790,//852,//785,         // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	33,         // Display Vertical Start Position
	600,        // Display Vertical Height

	752,        // Display Vertical Total Line Number in One Frame

	16,         // Display H Sync Width
	3,          // Display V Sync Height

	45,//39,         // Typical Pixel Clock in MHz
...
code PanelType Panel1 =
{
	...
	480,        // Display Horizontal Width

	752,        // 1Display Horizontal Total Clock Number in One Display Line

	752,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	752,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	24,         // Display Vertical Start Position
	234,        // Display Vertical Height

	352,        // Display Vertical Total Line Number in One Frame

	16,         // Display H Sync Width
	3,          // Display V Sync Height

	20,         // Typical Pixel Clock in MHz
...
code PanelType Panel2 =
{
	...
	1052,        // 1Display Horizontal Total Clock Number in One Display Line

	1052,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1052,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	32,         // Display Vertical Start Position
	600,        // Display Vertical Height

	810,        // Display Vertical Total Line Number in One Frame
