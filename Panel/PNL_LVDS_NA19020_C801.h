...
code PanelType Panel0 =
{
	...
	999,         // Display Horizontal Width

	1300,       // Display Horizontal Total Clock Number in One Display Line

	1300,       // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1300,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	34,         // Display Vertical Start Position
	512,       // Display Vertical Height
