...
code PanelType Panel0 =
{
   ...
   ///_RSDS_HL_SWAP |
	...
	810,        // Display Horizontal Total Clock Number in One Display Line

	810,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	810,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	32,//39,         // Display Vertical Start Position
