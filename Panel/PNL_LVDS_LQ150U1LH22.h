...
code PanelType Panel0 =
{
	...
	1600,       // Display Horizontal Width

	1952,//1152,     // Display Horizontal Total Clock Number in One Display Line

	1952,      // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1800,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	32,         // Display Vertical Start Position
	1200,       // Display Vertical Height

	1452,       // Display Vertical Total Line Number in One Frame

	16,         // Display H Sync Width
	3,          // Display V Sync Height

	104, //39,         // Typical Pixel Clock in MHz
