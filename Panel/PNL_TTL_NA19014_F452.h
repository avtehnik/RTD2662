...
code PanelType Panel0 =
{
	...
	60,         // Display Horizontal Start Position
	640,        // Display Horizontal Width

	730,        // Display Horizontal Total Clock Number in One Display Line

	730,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	730,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	33,         // Display Vertical Start Position
	480,        // Display Vertical Height

	600,        // Display Vertical Total Line Number in One Frame
