...
code PanelType Panel3 =
{
	...
	1680,       // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	1680,       // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC
