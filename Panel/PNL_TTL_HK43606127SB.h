...
code PanelType Panel0 =
{
   ...
   ///_RSDS_HL_SWAP |
	...
	168,         // Display Horizontal Start Position
	640,        // Display Horizontal Width

	980,        // Display Horizontal Total Clock Number in One Display Line

	900,        // Display Horizontal Total Clock Number in One Display Line for CVBS PAL
	900,        // Display Horizontal Total Clock Number in One Display Line for CVBS NTSC

	5,         // Display Vertical Start Position
...
code PanelType Panel1 =
{
	...
	44,         // Display Vertical Start Position
	600,        // Display Vertical Height

	680,        // Display Vertical Total Line Number in One Frame
