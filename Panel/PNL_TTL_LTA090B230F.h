...
{/*
	...
	134,         // Display Horizontal Start Position
	600,        // Display Horizontal Width

	952,        // 1Display Horizontal Total Clock Number in One Display Line
...
*/
	...
	32,         // Display Horizontal Start Position
	540,//532,        // Display Horizontal Width

	730,        // 1Display Horizontal Total Clock Number in One Display Line
	...
	8,         // Display Vertical Start Position
	328,        // Display Vertical Height
	...
	60, //(((DWORD)752 * (DWORD)450) * (DWORD)60 / (DWORD)1000000),         // Typical Pixel Clock in MHz
