...
BYTE xdata MCU_IRQ_STATUS_FF00			_at_ 0xFF00;
...
BYTE xdata MCU_VGA_DDC_ENA_FF1B         _at_ 0xFF1B;	// VGA DDC1
BYTE xdata MCU_DVI_DDC_ENA_FF1E         _at_ 0xFF1E;	// DVI DDC2
...
BYTE xdata MCU_HDMI_DDC_ENA_FF2C        _at_ 0xFF2C;	// HDMI DDC3
